...
export default function Footer() {
  return (
    <footer id="contact" className="bg-slate-900 text-slate-300 font-sans text-left relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-0 py-16 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-12 pb-12 border-b border-slate-800">
          ...
          <div className="md:col-span-5 space-y-6">
            ...
            <div className="space-y-2">
              <span className="text-xs font-black text-slate-500 uppercase tracking-widest block">Regional Hubs</span>
              <div className="flex flex-wrap gap-2 text-xs font-bold text-slate-300">
                <span className="flex items-center gap-1 bg-slate-800/80 border border-slate-700/50 px-2.5 py-1 rounded-full"><MapPin className="w-3 h-3 text-primary" /> Saudi Arabia</span>
                <span className="flex items-center gap-1 bg-slate-800/80 border border-slate-700/50 px-2.5 py-1 rounded-full"><MapPin className="w-3 h-3 text-primary" /> India</span>
                <span className="flex items-center gap-1 bg-slate-800/80 border border-slate-700/50 px-2.5 py-1 rounded-full"><MapPin className="w-3 h-3 text-primary" /> UAE</span>
                <span className="flex items-center gap-1 bg-slate-800/80 border border-slate-700/50 px-2.5 py-1 rounded-full"><MapPin className="w-3 h-3 text-primary" /> Qatar</span>
              </div>
            </div>
          </div>
          ...
          <div className="md:col-span-4 space-y-6">
            <h3 className="text-sm font-black text-slate-400 uppercase tracking-widest">Get In Touch</h3>
          ...
          <div className="md:col-span-3 space-y-6">
            <h3 className="text-sm font-black text-slate-400 uppercase tracking-widest">Quick Navigation</h3>
            <ul className="grid grid-cols-2 gap-x-4 gap-y-2.5 text-sm font-bold text-slate-400">
        ...
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs font-bold text-slate-500 uppercase tracking-wider">
