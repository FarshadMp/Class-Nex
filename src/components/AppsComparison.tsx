            ...
            <table className="w-full border-collapse text-left text-sm font-semibold text-slate-500">
              <thead>
                <tr className="bg-slate-50/50 border-b border-slate-100">
                  ...
                  <th className="p-6 text-slate-600 font-bold text-base w-[35%]">
              ...
              <tbody className="divide-y divide-slate-100">
                {comparisonData.map((row, idx) => (
                  <tr key={idx} className={`hover:bg-slate-50/30 transition-colors ${row.highlight ? "bg-emerald-50/5" : ""}`}>
                    ...
                    <td className="p-6 font-semibold text-slate-600">
                      <div className="flex items-start gap-2.5">
                        <span className="w-5 h-5 bg-slate-100 text-slate-600 rounded-full flex items-center justify-center shrink-0 mt-0.5">
